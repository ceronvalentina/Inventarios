...
require_once "main.php";
    ...
    if ($_FILES['usuario_imagen']['name'] == "" || $_FILES['usuario_imagen']['size'] == 0) {
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
    ...
    if (mime_content_type($_FILES['usuario_imagen']['tmp_name']) != "image/jpeg" && mime_content_type($_FILES['usuario_imagen']['tmp_name']) != "image/png") {
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
    ...
    if (($_FILES['usuario_imagen']['size'] / 1024) > 3072) {
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
    ...
    switch (mime_content_type($_FILES['usuario_imagen']['tmp_name'])) {
        case 'image/jpeg':
            $img_ext = ".jpg";
            break;
        case 'image/png':
    ...
    /* Nombre de la imagen */
    $img_nombre = renombrar_fotos($datos['usuario_imagen']);

    /* Nombre final de la imagen */
    $foto = $img_nombre . $img_ext;

    /* Moviendo imagen al directorio */
    if (!move_uploaded_file($_FILES['usuario_imagen']['tmp_name'], $img_dir . $foto)) {
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
        ...
        echo '
            <div class="notification is-info is-light">
                ...
                <p class="has-text-centered pt-5 pb-5">
                    <a href="index.php?vista=product_img&usuario_id_up=' . $product_id . '" class="button is-link is-rounded">Aceptar</a>
                </p">
            </div>
            <script>
        window.history.go(-1);
